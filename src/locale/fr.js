export default {
  ...
  layout: {
    ...
    privacy: {
      cookiesText: 'Ce site utilise des cookies pour fonctionner.',
      cookiesButton: 'Lire la politique de confidentialité',
  ...
  meta: {
    'home/About': { 'title': 'A propos', 'description': 'Page d\'à propos' },
    'home/Feedback': { 'title': 'Feedback', 'description': 'Page de feedback' },
    'home/Help': { 'title': 'Aide', 'description': 'Page d\'aide' },
    'home/Privacy': { 'title': 'Confidentialité', 'description': 'Page de confidentialité' },
    'Callback': { 'title': 'Retour à l\'application...', 'description': 'Page de retour' },
    'Forbidden': { 'title': 'Interdit', 'description': 'Page pour accès à des ressources interdites' },
    'NotFound': { 'title': 'Non trouvé', 'description': 'Page pour accès à des ressources non trouvées' },
    'SilentCallback': { 'title': 'Retour à l\'application...', 'description': 'Page de retour' }
  },
  pages: {
    forbidden: {
    ...
    home: {
      about: {
        ...
        developedBy: 'Développé par {contact}',
        releaseInformation: 'Informations sur la version'
      },
      feedback: {
        title: 'Votre avis',
        catch: 'Votre opinion est importante !',
